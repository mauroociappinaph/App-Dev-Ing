...
import { useClientLearningStore, type Level } from "@/store/client-store";

const levelDescriptions = {
  BEGINNER: {
    title: "Principiante",
    description:
      "Ideal si estás empezando a aprender inglés técnico. Enfocado en vocabulario básico y frases esenciales para el desarrollo.",
    features: [
  ...
  INTERMEDIATE: {
    title: "Intermedio",
    description:
      "Para quienes ya tienen bases y quieren mejorar su comunicación profesional en entornos de desarrollo.",
    features: [
  ...
  ADVANCED: {
    title: "Avanzado",
    description:
      "Perfecciona tu inglés para liderazgo técnico, presentaciones y comunicación a nivel ejecutivo.",
    features: [
    ...
    <div className="space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-tech-muted">
          Elige el nivel que mejor describe tu conocimiento actual del inglés
          técnico
        </p>
      </div>
          ...
          return (
            ...
            >
              <CardHeader className="text-center pb-4">
                <div
                  className={`mx-auto w-16 h-16 rounded-full ${config.color} bg-opacity-10 flex items-center justify-center mb-3`}
                >
          ...
          <div className="space-y-6">
            <div className="text-center space-y-2">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Aprende inglés técnico con contenido diseñado específicamente
                para programadores. Mejora tu comunicación profesional en
            ...
            <div className="max-w-md mx-auto space-y-4">
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                <p className="text-sm text-blue-800">
                  ...
                  {levelDescriptions[userData.level].title}
                </p>
              </div>
            </div>
          </div>
